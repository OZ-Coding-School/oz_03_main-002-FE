...
function Layout() {
  return (
    ...
    >
      <div className="relative h-dvh sm:h-[800px] md:h-[800px] w-full sm:w-full md:w-[360px] bg-white shadow-2xl sm:rounded-3xl md:rounded-3xl mx-auto min-w-[360px] overflow-auto">
        <GlobalHeader />
        <Outlet />
      </div>
    </div>
